...
bool dingo_msgs__msg__electrical_measurements__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dingo_msgs.msg._electrical_measurements.ElectricalMeasurements", full_classname_dest, 62) == 0);
  }
  dingo_msgs__msg__ElectricalMeasurements * ros_message = _ros_message;
...
PyObject * dingo_msgs__msg__electrical_measurements__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("dingo_msgs.msg._electrical_measurements");
