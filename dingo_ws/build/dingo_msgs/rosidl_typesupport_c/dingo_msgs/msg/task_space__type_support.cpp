...
static const _TaskSpace_type_support_symbol_names_t _TaskSpace_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dingo_msgs, msg, TaskSpace)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dingo_msgs, msg, TaskSpace)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, dingo_msgs, msg, TaskSpace)() {
  return &::dingo_msgs::msg::rosidl_typesupport_c::TaskSpace_message_type_support_handle;
}
