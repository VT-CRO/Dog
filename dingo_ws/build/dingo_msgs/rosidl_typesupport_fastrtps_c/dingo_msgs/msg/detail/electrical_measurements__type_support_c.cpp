...
#include "dingo_msgs/msg/detail/electrical_measurements__rosidl_typesupport_fastrtps_c.h"
...
using _ElectricalMeasurements__ros_msg_type = dingo_msgs__msg__ElectricalMeasurements;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dingo_msgs
bool cdr_serialize_dingo_msgs__msg__ElectricalMeasurements(
  const dingo_msgs__msg__ElectricalMeasurements * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dingo_msgs
bool cdr_deserialize_dingo_msgs__msg__ElectricalMeasurements(
  eprosima::fastcdr::Cdr & cdr,
  dingo_msgs__msg__ElectricalMeasurements * ros_message)
{
  // Field name: battery_voltage_level
  {
    cdr >> ros_message->battery_voltage_level;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dingo_msgs
size_t get_serialized_size_dingo_msgs__msg__ElectricalMeasurements(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dingo_msgs
size_t max_serialized_size_dingo_msgs__msg__ElectricalMeasurements(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dingo_msgs__msg__ElectricalMeasurements;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dingo_msgs
bool cdr_serialize_key_dingo_msgs__msg__ElectricalMeasurements(
  const dingo_msgs__msg__ElectricalMeasurements * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: battery_voltage_level
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dingo_msgs
size_t get_serialized_size_key_dingo_msgs__msg__ElectricalMeasurements(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ElectricalMeasurements__ros_msg_type * ros_message = static_cast<const _ElectricalMeasurements__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dingo_msgs
size_t max_serialized_size_key_dingo_msgs__msg__ElectricalMeasurements(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const dingo_msgs__msg__ElectricalMeasurements * ros_message = static_cast<const dingo_msgs__msg__ElectricalMeasurements *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_dingo_msgs__msg__ElectricalMeasurements(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  dingo_msgs__msg__ElectricalMeasurements * ros_message = static_cast<dingo_msgs__msg__ElectricalMeasurements *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_dingo_msgs__msg__ElectricalMeasurements(cdr, ros_message);
}

static uint32_t _ElectricalMeasurements__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_dingo_msgs__msg__ElectricalMeasurements(
...
static size_t _ElectricalMeasurements__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_dingo_msgs__msg__ElectricalMeasurements(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dingo_msgs, msg, ElectricalMeasurements)() {
